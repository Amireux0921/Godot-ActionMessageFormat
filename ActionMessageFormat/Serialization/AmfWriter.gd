...
func WriteAmfPacket(value:AMF_Packet):
	if value.Version == AMF_Packet.AmfVersion.AMF0:
		self.WriteInt16(0)
	else:
		self.WriteInt16(3)
...
func WriteAmfBody(value:AMF_Body):
...
func WriteAmfHeaders(value:Array[AMF_Header]):
...
func WriteAmfBodys(value:Array[AMF_Body]):
	self.WriteInt16(value.size())
...
func WriteAmf0(value:Variant):
	...
	if value == null:
		...
		if length > ActionMessageFormat.AmfType.AMF0_STRING_MAX_LENGTH:
...
func WriteAmf0Date(value:DateTimes):
	self.WriteDouble(value.Times)
	self.WriteInt16(0)
...
func WriteAmf3(value:Variant):
	...
	if value == null:
		...
		if value < ActionMessageFormat.AmfType.INT29_MIN_VALUE || value > ActionMessageFormat.AmfType.INT29_MAX_VALUE:
...
func WriteAmf3Date(value:DateTimes):
